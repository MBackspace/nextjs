      ...
      <footer className="row-start-3 flex gap-[24px] flex-wrap w-full py-[33px] items-center justify-center bg-[var(--theme-bg-base)] border-t border-[var(--theme-border-base)]">
        <div className={`w-full max-w-screen-xl flex flex-col gap-[55px] ${isShortScreen ? "px-[25px]" : "px-[40px]"}`}>
            ...
            <div className={`grid ${isShortScreen ? "grid-cols-[5.5fr_7fr_8.5fr_7.5fr_12fr]" : "grid-cols-[6.5fr_7fr_8.5fr_7.5fr_9fr]"} text-[14px]`}>
              ...
              <div>
                ...
                <nav className="flex flex-col space-y-3">
                  ...
                  <button
                    className="cursor-pointer transition duration-200 ease-in-out text-left text-[var(--theme-text-muted)] hover:text-[var(--theme-fg-base)]"
              ...
              <div>
                ...
                <div className="relative w-full">
                  <form>
                    <input
                      className="w-full cursor-pointer border border-[var(--theme-bg-muted)] bg-[var(--theme-bg-muted)] text-[14px] text-[var(--theme-fg-base)] placeholder-[var(--theme-text-muted)] px-[10px] py-[5px] rounded-lg focus:outline-none focus:ring-2 ring-offset-2 focus:ring-[var(--theme-primary-light)] ring-offset-[var(--theme-bg-base)]"
                      type="email"
                      name="email"
          ...
          <div className="flex flex-row justify-between items-center">
            <div className="flex flex-col items-start text-[var(--theme-text-muted)] text-[14px]">
              <span className="pb-[15px]">© 2025 Vercel, Inc.</span>
              <div className="flex flex-row items-center gap-x-3">
                <Link href={`/${i18n.language}/github`}>
                  <svg data-testid="geist-icon" width="16" height="16" viewBox="0 0 16 16" fill="currentColor" strokeLinejoin="round">
