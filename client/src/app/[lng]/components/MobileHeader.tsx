...
export default function MobileHeader({ t, i18n, toggleSearch }: MobileHeaderProps): React.ReactNode {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full h-[65px] z-50 flex items-center border-b border-[#ededed] px-6 py-[15px] bg-[#ffffff] font-[family-name:var(--font-geist-sans)]">
